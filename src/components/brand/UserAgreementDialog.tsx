...
const agreementVersion = '2026-01';
...
export function UserAgreementDialog({ user }: { user: UserRecord | null }) {
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-slate-950/80 px-4 backdrop-blur-md">
      <section className="w-full max-w-xl rounded-[1.75rem] border border-white/10 bg-slate-950 p-6 shadow-[0_32px_120px_rgba(0,0,0,0.42)]">
        ...
        <button
          ...
          className="mt-6 rounded-2xl bg-teal-400 px-5 py-3 text-sm font-semibold text-slate-950 transition hover:bg-teal-300"
        >
